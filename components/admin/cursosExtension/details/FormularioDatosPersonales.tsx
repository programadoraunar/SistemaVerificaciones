...
const FormularioDatosPersonales: React.FC<FormularioDatosPersonalesProps> = ({
  ...
  React.useEffect(() => {
    reset({
      nombre_cursoextension: nombre,
      apellido_cursoextension: apellido,
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="flex flex-col lg:flex-row w-full lg:gap-8">
        <div className="mb-4 w-[100%] lg:w-[50%]">
          ...
          <input
            type="text"
            {...register("nombre_cursoextension", { required: true })}
            className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2"
          />
        </div>
        <div className="mb-4 w-[100%] lg:w-[50%]">
          ...
          <input
            type="text"
            {...register("apellido_cursoextension", { required: true })}
            className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2"
          />
        </div>
      </div>
      <div className="flex flex-col lg:flex-row w-full lg:gap-8"></div>
